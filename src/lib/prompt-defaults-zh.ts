...
- narration (旁白) 與 dialogue (對白) 必須使用目標書籍的 Writing Language 撰寫。
- visualPrompt、negativePrompt、action、setting、location、emotion、shotType、cameraAngle 必須**全部以英文 (English)** 撰寫，以達到最佳的生圖效果。
- 不要捏造正文沒有支撐的重大事件。
